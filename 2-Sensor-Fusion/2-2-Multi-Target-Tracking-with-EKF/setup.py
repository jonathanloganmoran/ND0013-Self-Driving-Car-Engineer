...
descr = 'Project 2.2: Multi-Target Tracking with Extended Kalman Filter and Sensor Fusion from Course 2: Sensor Fusion in the Self-Driving Car Engineer Nanodegree programme.'

setup(
    name='ND0013-Project-2-2-Multi-Target-Tracking-with-EKF',
    version='0.0',
    description=descr,
