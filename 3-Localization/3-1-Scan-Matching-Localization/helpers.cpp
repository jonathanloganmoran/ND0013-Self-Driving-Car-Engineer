 ...
 *
 * Purpose of this file: Helper functions used to perform the simulated
 * 						 LiDAR scans, visualise the 2D or 3D environment, 
 * 						 and represent the simulated vehicle state in the
 * 						 CARLA Simulator.
 *
