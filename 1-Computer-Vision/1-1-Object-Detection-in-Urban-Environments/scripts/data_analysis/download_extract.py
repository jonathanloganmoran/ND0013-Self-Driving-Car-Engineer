...
def download_and_process(path_to_filenames: str, data_dir: str, delete_records=False):
    ...
    logger.info(
        f'Downloading {len(filename_paths)} files. Be patient, this will take a long time.'
    )
...
if __name__ == '__main__':
    files = ["/Volumes/SanDisk Extreme SSD/ND0013/data/raw/segment-10017090168044687777_6380_000_6400_000_with_camera_labels.tfrecord"]

    df = process_tfrs(files)
    print(df)
